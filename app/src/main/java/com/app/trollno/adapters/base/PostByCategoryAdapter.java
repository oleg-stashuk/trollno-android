package com.app.trollno.adapters.base;
...
public class PostByCategoryAdapter extends RecyclerView.Adapter<PostByCategoryAdapter.FreshPostHolder>{
    ...
    public PostByCategoryAdapter(PrefUtils prefUtils, GridLayoutManager gridLayoutManager,
    ...
    public class FreshPostHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTo(PostsModel.PostDetails item, OnItemClick<PostsModel.PostDetails> itemClickListener) {
            ...
            CategoryModel category = CategoryStoreProvider.getInstance(itemView.getContext()).getCategoryById(item.getCategoryId());
