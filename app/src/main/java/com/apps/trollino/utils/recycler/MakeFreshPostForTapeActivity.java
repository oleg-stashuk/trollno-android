...
import com.apps.trollino.db_room.category.CategoryStore;
...
public class MakeFreshPostForTapeActivity {
    ...
    public static void makeNewPostsRecyclerView(Context context, PrefUtils prefUtils, RecyclerView recyclerView,
        ...
        PostListAdapter adapter = new PostListAdapter((BaseActivity) cont, prefUtils, gridLayoutManager,
        ...
        Objects.requireNonNull(recyclerView.getLayoutManager()).scrollToPosition(savedPostPosition);
        ...
        recyclerView.addOnScrollListener(new RecyclerScrollListener() {
            ...
            public void onScrolledToEnd() {
                ...
                Objects.requireNonNull(recyclerView.getLayoutManager()).scrollToPosition(
                        PostStoreProvider.getInstance(context).getPostByCategoryName(CATEGORY_FRESH).size()-1);
                infiniteScroll(recyclerView, shimmer, refreshLayout, bottomNavigation, adapter, progressBar);
            }
        });
    }
