...
public class ThirdTabFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = view.findViewById(R.id.refresh_third_tab);
        recycler = view.findViewById(R.id.recycler_third_tab);
        progressBar = view.findViewById(R.id.progress_third_tab);
        bottomLine = view.findViewById(R.id.line_third_tab);
    }

    @Override
    protected void initView() {
        categoryId = CategoryStoreProvider.getInstance(context).getCategoryList().get(2).getIdCategory();
        String categoryName = CategoryStoreProvider.getInstance(context).getCategoryList().get(2).getNameCategory();
