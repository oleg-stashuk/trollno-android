...
public class FifthTabFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = view.findViewById(R.id.refresh_fifth_tab);
        recycler = view.findViewById(R.id.recycler_fifth_tab);
        progressBar = view.findViewById(R.id.progress_fifth_tab);
    }

    @Override
    protected void initView() {
        categoryId = CategoryStoreProvider.getInstance(context).getCategoryList().get(4).getIdCategory();
        String categoryName = CategoryStoreProvider.getInstance(context).getCategoryList().get(4).getNameCategory();
