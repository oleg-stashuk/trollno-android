...
public class FreshPostsFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = view.findViewById(R.id.refresh_fresh);
        recycler = view.findViewById(R.id.recycler_fresh);
        progressBar = view.findViewById(R.id.progress_fresh);
    }
    ...
    private final FreshPostAdapter.OnItemClick<PostsModel.PostDetails> newPostsItemListener = (item) -> {
