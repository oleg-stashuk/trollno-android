...
public class FourthTabFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = view.findViewById(R.id.refresh_fourth_tab);
        recycler = view.findViewById(R.id.recycler_fourth_tab);
        progressBar = view.findViewById(R.id.progress_fourth_tab);
        bottomLine = view.findViewById(R.id.line_fourth_tab);
    }
